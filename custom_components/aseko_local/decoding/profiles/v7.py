...
SALT = Profile(
    ...
    evidence={
        **_COMMON_EVIDENCE,
        ...
        ElectrolyzerDirection: "observed: left, right and waiting all seen (own SALT dumps, 37 frames 2026-08-08..28); polarity not compared with the display",
        ...
        VspPumpRunning: "observed: byte[22] toggles 0x10 / 0x18 across the own SALT dumps, 37 frames 2026-08-08..28; not compared with the pump",
        PhMinusConcentration: "observed: byte[112] = 14 then 15 % in the own SALT dumps, 37 frames 2026-08-08..28; not compared with the setting",
        WaterLevel: "observed: byte[27] 14..25 cm across the own SALT dumps, 37 frames 2026-08-08..28; not compared with the display",
        WaterLevelLowAlarm: "observed: byte[102] = 5 and 31 cm on the two units of the own SALT dumps, 37 frames 2026-08-08..28; thresholds ordered low < on < off < high",
        WaterLevelFillingOn: "observed: byte[103] = 10 and 33 cm on the two units of the own SALT dumps, 37 frames 2026-08-08..28",
        WaterLevelFillingOff: "observed: byte[104] = 25 and 35 cm on the two units of the own SALT dumps, 37 frames 2026-08-08..28",
        WaterLevelHighAlarm: "observed: byte[105] = 40 and 56..73 cm on the two units of the own SALT dumps, 37 frames 2026-08-08..28",
        ...
        RequiredRedox: "observed: byte[53] * 10 = 670 mV on the REDOX unit of the own SALT dumps, 37 frames 2026-08-08..28",
        ClFree: "observed: bytes 16-17 = 0.77 and 0.93 mg/l on the CLF unit (serial 110194590) of the own SALT dumps, 37 frames 2026-08-08..28",
        ClFreeMv: "observed: bytes 20-21 = 6656 and 6934 mV on the CLF unit of the own SALT dumps, 37 frames 2026-08-08..28",
        RequiredClFree: "observed: byte[53] / 10 = 0.9 mg/l on the CLF unit of the own SALT dumps, 37 frames 2026-08-08..28",
        RequiredClDose: "unverified: byte[53] for a DOSE unit; neither unit of the own SALT dumps, 37 frames 2026-08-08..28 is one",
        RequiredWaterTemperature: "observed: byte[55] = 25 C in every frame of the own SALT dumps, 37 frames 2026-08-08..28; not compared with the setting",
