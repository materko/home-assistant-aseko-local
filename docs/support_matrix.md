...
| field | HOME firmware A | HOME firmware B | SALT | OXY | NET | PROFI | unknown unit type |
|---|---|---|---|---|---|---|---|
| `air_temperature` | — | — | ✅ | — | — | — | — |
...
| `configuration` | ✅ `decode_v7_by_unit_type_byte` | ✅ `decode_v7_by_unit_type_byte` | ✅ | ✅ `decode_v7_ph_and_oxy` | ✅ | ❓ `decode_v7_without_dose` | ❓ `decode_v7_all_probes` |
| `delay_after_dose` | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ❓ |
| `delay_after_startup` | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ❓ |
| `electrolyzer_active` | — | — | ✅ | — | — | — | — |
